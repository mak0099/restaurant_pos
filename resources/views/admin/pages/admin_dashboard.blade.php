...
$total_sales = App\Order::select(DB::raw('SUM(grand_total) as amount'))->first()->amount + 0;
$total_costs = App\CostHistory::select(DB::raw('SUM(amount) as amount'))->where('deletation_status', false)->first()->amount + 0;
