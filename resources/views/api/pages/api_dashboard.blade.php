                    ...
                    <div class="span12">
                        <div class="quick-actions_homepage">
                            <ul class="quick-actions">
                                <li class="bg_lb"> <a style="height: 100px; min-width: 150px;"><h4> <i class="fa fa-list-alt"></i> Categories</h4> <h4>{{$category_count}}</h4> Total categories</a> </li>
                                <li class="bg_ls"> <a style="height: 100px; min-width: 150px;"><h4> <i class="fa fa-gift"></i> Products</h4> <h4>{{$p_product_count}}</h4> Published products</a> </li>
                                <li class="bg_lg"> <a  style="height: 100px; min-width: 150px;"> <h4><i class="fa fa-first-order"></i> Order</h4><h4>{{$order_count}}</h4> Total orders</a> </li>
                                <li class="bg_ly"> <a  style="height: 100px; min-width: 150px;"> <h4>Total Sales</h4><h4>{{$total_sales}}</h4> BDT</a> </li>
                                <li class="bg_lb"> <a  style="height: 100px; min-width: 150px;"> <h4>Total Costs</h4> <h4>{{$total_costs}}</h4> BDT</a> </li>
                                <li class="bg_lo"> <a style="height: 100px; min-width: 150px;"><h4> Balance</h4> <h4>{{$balance}}</h4> BDT</a> </li>
                            </ul>
                        </div>
                    </div>
                </div>
